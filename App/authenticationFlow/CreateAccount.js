      ...
      <View style={styles.container}>
        ...
        <View style={styles.inputContainer}>
          <TextInput
            ...
            placeholder={i18n.t("create_account_mail")}
          ...
          <TextInput
            style={styles.textInput}
            placeholder={i18n.t("create_account_passwd")}
          ...
          <TextInput
            style={styles.textInput}
            placeholder={i18n.t("confirm_passwd")}
        ...
        <View style={styles.personalInformartionContainer}>
          <View style={styles.nameFornamePhoneContainer}>
            <TextInput
              style={styles.textInput}
              placeholder={i18n.t("create_account_name")}
            ...
            <TextInput
              style={styles.textInput}
              placeholder={i18n.t("create_account_forname")}
            ...
            <TextInput
              style={styles.textInput}
              placeholder={i18n.t("create_account_phone")}
          ...
          <View style={styles.adressContainer}>
            <TextInput
              style={styles.textInput}
              placeholder={i18n.t("create_account_adress")}
            ...
            <View style={styles.centeredView}>
              <View style={styles.modalView}>
                <Text style={styles.modalText}>
                  {i18n.t("account_created_confirmation")} {this.state.userMail}
                </Text>
                <TouchableHighlight
                  style={{
                    ...styles.openButton,
